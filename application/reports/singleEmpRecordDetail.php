...
$page_title = "Single Employee Records";
require_once(FOLDER_Template . 'header.php');

$eName = $_GET['empName'];
$empID = $_GET['eid'];

$table_Name = 'employee e';
$fields = 'e.*';
$join = NULL;
$where = "e.serial_no=$empID";
$orderBy = NULL;
...
extract($row);
$serial = $serial_no; //left name below mentioned name, right name db name
        ...
        <div class="row">
            <div class='table-responsive col-lg-5'>
                <table id="dataTable1" class='table table-striped table-hover table-responsive table-bordered'>
                    <tr>
                        <td  class='col-md-3'>Serial No &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:-</td>
                    ...
                    <tr>
                        <td  class='col-md-3'>Appointment Date &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:-</td>
                        <td><?php echo $appoinment_date ?></td>
                    </tr>
                    <tr>
                        <td  class='col-md-3'>NIC &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:-</td>
                        <td><?php echo $nic ?></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td  class='col-md-3'>Work Site &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:-</td>
                        <td><?php echo $workSite ?></td>
                    </tr>
                    <tr>
                        <td  class='col-md-3'>Img &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:-</td>
                        <td><?php echo $img ?></td>
                    </tr>
                    <tr>
                        <td  class='col-md-3'>Basic Salary &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:-</td>
                        <td><?php echo $basicSalary ?></td>
                    </tr>
                    <tr>
                        <td  class='col-md-3'>Work Target &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:-</td>
                        <td><?php echo $workTarget ?></td>
                    </tr>
                    <tr>
                        <td  class='col-md-3'>Splntencive &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:-</td>
                        <td><?php echo $splntencive ?></td>
                    </tr>
                    <tr>
                        <td  class='col-md-3'>Difficult &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:-</td>
                        <td><?php echo $difficult ?></td>
                    </tr>
                    <tr>
                        <td  class='col-md-3'>Other &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:-</td>
