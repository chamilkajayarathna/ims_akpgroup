...
echo "</div>";
echo "<div class='right-button-margin'>";
echo "<a href='index.php' class='btn btn-default pull-right left-margin'>Back</a>";
                            ...
                            <table class='table table-responsive'>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        echo "</select>";
                                        ?>
                                        <input type="button" value="Admin" onClick="location.href = 'adminEditPage.php'" class="btn btn-primary pull-right"><br/></td>
                                </tr>
                                <tr>
                                    <td align="right"> <strong>Machine No: *</strong></td>
                                    <td><input type="text" name="mnum" value="<?php echo $mnum ?>"  class='form-control' required/><br/></td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php
                                        echo "<select class='form-control' name='name' id='nameIdMachine' required>";
                                        foreach ($name as $machineName) {
                                            if ($db_name == $machineName['machineCategory']) {
                                                echo "<option value='" . $machineName['machineCategory'] . "' selected>";
                                            } else {
                                                echo "<option value='" . $machineName['machineCategory'] . "'>";
                                            }
                                            echo $machineName['machineCategory'] . "</option>";
                                        }
                                        echo "</select>";
...
if (isset($_GET['id'])) {
    ...
    if (isset($_POST['addNew'])) {
        ...
        //renderForm($id,$mnum,$name,$brnd,$model,$eModel,$eSerial,$cSerial,$year, $details, $site1,$db_brnd,$db_machinName);
    }
} else {
